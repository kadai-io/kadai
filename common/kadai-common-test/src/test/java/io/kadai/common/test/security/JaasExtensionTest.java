...
class JaasExtensionTest {
  ...
  private static final DynamicTest NOT_NULL_DYNAMIC_TEST =
      dynamicTest(
          "dynamic test",
          () -> assertThat(CURRENT_USER_CONTEXT.getUserContext().getUserId()).isNotNull());
  private static final DynamicTest NULL_DYNAMIC_TEST =
      dynamicTest(
          "dynamic test",
          () -> assertThat(CURRENT_USER_CONTEXT.getUserContext().getUserId()).isNull());
  private static final DynamicTest DYNAMIC_TEST_USER_DYNAMIC_TEST =
      dynamicTest(
          "dynamic test",
          () ->
              assertThat(CURRENT_USER_CONTEXT.getUserContext().getUserId())
  ...
  static void should_SetJaasSubject_When_AnnotationExists_On_BeforeAll() {
    assertThat(CURRENT_USER_CONTEXT.getUserContext().getUserId()).isEqualTo("beforeall");
  }
  ...
  static void should_SetJaasSubject_When_AnnotationExists_On_AfterAll() {
    assertThat(CURRENT_USER_CONTEXT.getUserContext().getUserId()).isEqualTo("afterall");
  }
  ...
  void should_SetJaasSubject_When_AnnotationExists_On_BeforeEach() {
    assertThat(CURRENT_USER_CONTEXT.getUserContext().getUserId()).isEqualTo("beforeeach");
  }
  ...
  void should_SetJaasSubject_When_AnnotationExists_On_AfterEach() {
    assertThat(CURRENT_USER_CONTEXT.getUserContext().getUserId()).isEqualTo("aftereach");
  }
  ...
  void should_SetJaasSubject_When_AnnotationExists_On_Test() {
    assertThat(CURRENT_USER_CONTEXT.getUserContext().getUserId()).isEqualTo("user");
  ...
  List<DynamicTest> should_SetJaasSubject_When_AnnotationExists_On_TestFactory() {
    assertThat(CURRENT_USER_CONTEXT.getUserContext().getUserId()).isEqualTo("testfactory");
    return List.of();
  }
  ...
  List<DynamicTest>
    ...
    assertThat(CURRENT_USER_CONTEXT.getUserContext().getUserId()).isEqualTo("testfactory1");
    return List.of();
  }
  ...
  void should_SetSaasSubject_When_SingleAnnotationExistsOnParameterizedTest(DayOfWeek dayOfWeek) {
    ...
    assertThat(CURRENT_USER_CONTEXT.getUserContext().getUserId()).isEqualTo("testtemplate");
  }
  ...
  void should_SetMultipleJaasSubjects_When_MultipleAnnotationsExist_On_TestTemplate(
    ...
    assertThat(CURRENT_USER_CONTEXT.getUserContext().getUserId()).isEqualTo(accessId.user());
  }
  ...
  class ConstructorWithAccessId {
    ...
    ConstructorWithAccessId() {
      assertThat(CURRENT_USER_CONTEXT.getUserContext().getUserId()).isEqualTo("constructor");
    }
