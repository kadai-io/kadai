...
public interface UserMapper {
  ...
  @Result(property = "orgLevel1", column = "ORG_LEVEL_1")
  @Result(property = "data", column = "DATA")
  @SelectProvider(type = UserMapperSqlProvider.class, method = "findByOrgLevel1")
  List<UserImpl> findByOrgLevel1(@Param("orgLevel") String orgLevel);
  ...
  @Result(property = "orgLevel1", column = "ORG_LEVEL_1")
  @Result(property = "data", column = "DATA")
  @SelectProvider(type = UserMapperSqlProvider.class, method = "findByOrgLevel2")
  List<UserImpl> findByOrgLevel2(@Param("orgLevel") String orgLevel);
  ...
  @Result(property = "orgLevel1", column = "ORG_LEVEL_1")
  @Result(property = "data", column = "DATA")
  @SelectProvider(type = UserMapperSqlProvider.class, method = "findByOrgLevel3")
  List<UserImpl> findByOrgLevel3(@Param("orgLevel") String orgLevel);
  ...
  @Result(property = "orgLevel1", column = "ORG_LEVEL_1")
  @Result(property = "data", column = "DATA")
  @SelectProvider(type = UserMapperSqlProvider.class, method = "findByOrgLevel4")
  List<UserImpl> findByOrgLevel4(@Param("orgLevel") String orgLevel);
