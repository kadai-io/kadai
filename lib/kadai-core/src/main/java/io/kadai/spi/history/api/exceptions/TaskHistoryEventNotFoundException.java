 ...
 */
public class TaskHistoryEventNotFoundException extends KadaiException {

  public static final String ERROR_KEY = "TASK_HISTORY_EVENT_NOT_FOUND";
  private final String historyEventId;

  public TaskHistoryEventNotFoundException(String historyEventId) {
    super(
