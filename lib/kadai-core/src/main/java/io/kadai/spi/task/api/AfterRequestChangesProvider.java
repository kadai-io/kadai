 ...
 */
public interface AfterRequestChangesProvider extends KadaiInitializable {
   ...
   * @throws Exception if the service provider throws any exception
   */
  default Task afterRequestChanges(Task task, String workbasketId, String ownerId)
      throws Exception {
    return afterRequestChanges(task);
  }
}
