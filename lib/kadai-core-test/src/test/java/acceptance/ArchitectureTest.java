...
class ArchitectureTest {
  ...
  @Test
  void implClassesShouldResideInInternalPackages() {
    classes()
        .that()
        ...
        .and()
        .resideOutsideOfPackages("..testapi..")
        .should()
  ...
  @Test
  void mapperInterfacesShouldResideInInternalPackages() {
    classes()
        .that()
        .haveSimpleNameEndingWith("Mapper")
        .and()
  ...
  @Test
  void sqlProviderClassesShouldBeTreatedAsUtilityClasses() {
    classes()
        .that()
        .haveSimpleNameEndingWith("SqlProvider")
        .should()
  ...
  @Test
  void serviceInterfacesShouldResideInApiPackages() {
    classes()
        .that()
  ...
  @Test
  void queryInterfacesShouldResideInApiPackages() {
    classes()
        .that()
