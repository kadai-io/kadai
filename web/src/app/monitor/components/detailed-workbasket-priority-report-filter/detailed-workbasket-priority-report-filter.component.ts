...
@Component({
  selector: 'kadai-monitor-detailed-workbasket-priority-report-filter',
  templateUrl: './detailed-workbasket-priority-report-filter.component.html',
  styleUrls: ['./detailed-workbasket-priority-report-filter.component.scss'],
  imports: [MatAccordion, MatExpansionPanel, MatExpansionPanelHeader, MatExpansionPanelTitle, MatCheckbox]
})
export class DetailedWorkbasketPriorityReportFilterComponent implements OnInit, OnDestroy {
  isPanelOpen = false;
  filters: {}[];
  keys: string[];
  activeFilters = [];
