...
describe('KADAI Monitor', () => {
  ...
  it('should visit kadai tasks by status monitor page', () => {
    ...
    cy.visitMonitor();
    cy.get('.monitor__navbar').contains('Tasks by Status').click();
    cy.verifyPageLoad('/tasks-status');
    cy.get('.monitor__navbar').find('.mdc-tab--active').should('contain', 'Tasks by Status');
    cy.wait('@monitorData');
  ...
  it('should visit kadai tasks by priority monitor page', () => {
    ...
    cy.visitMonitor();
    cy.get('.monitor__navbar').contains('Tasks by Priority').click();
    cy.verifyPageLoad('/tasks-priority');
    cy.get('.monitor__navbar').find('.mdc-tab--active').should('contain', 'Tasks by Priority');
    cy.wait('@monitorData');
    cy.get('canvas').should('be.visible');
  });
  ...
  it('should visit kadai workbaskets monitor page', () => {
    ...
    cy.visitMonitor();
    cy.get('.monitor__navbar').contains('Workbaskets').click();
    cy.verifyPageLoad('/workbaskets');
    cy.get('.monitor__navbar').find('.mdc-tab--active').should('contain', 'Workbaskets');
    cy.wait('@monitorData');
    cy.get('canvas').should('be.visible');
  });
  ...
  it('should visit kadai classifications monitor page', () => {
    ...
    cy.visitMonitor();
    cy.get('.monitor__navbar').contains('Classifications').click();
    cy.verifyPageLoad('/classifications');
    cy.get('.monitor__navbar').find('.mdc-tab--active').should('contain', 'Classifications');
    cy.wait('@monitorData');
    cy.get('canvas').should('be.visible');
  });
  ...
  it('should visit kadai timestamp monitor page', () => {
    ...
    cy.visitMonitor();
    cy.get('.monitor__navbar').contains('Timestamp').click();
    cy.verifyPageLoad('/timestamp');
    cy.get('.monitor__navbar').find('.mdc-tab--active').should('contain', 'Timestamp');
    cy.wait('@monitorData');
