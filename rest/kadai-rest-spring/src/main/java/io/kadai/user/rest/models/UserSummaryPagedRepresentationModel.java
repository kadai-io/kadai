...
public class UserSummaryPagedRepresentationModel
    extends PagedRepresentationModel<UserSummaryRepresentationModel> {

  @ConstructorProperties({"users", "page"})
  public UserSummaryPagedRepresentationModel(
