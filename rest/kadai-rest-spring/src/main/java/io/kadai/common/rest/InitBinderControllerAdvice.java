...
public class InitBinderControllerAdvice {
  ...
  @Autowired
  public InitBinderControllerAdvice(JsonMapper jsonMapper) {
  ...
  public void initBinder(WebDataBinder binder) {
    binder.registerCustomEditor(
        ...
        new JsonPropertyEditor(jsonMapper, PriorityColumnHeaderRepresentationModel.class));
    binder.registerCustomEditor(
        ObjectReference.class, new JsonPropertyEditor(jsonMapper, ObjectReferenceImpl.class));
